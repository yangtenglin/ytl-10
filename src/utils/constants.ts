export const GAME_CONFIG = {
  ...
  RESERVATION_RESCHEDULE_DEPOSIT_LOSS: 0.5,
  ...
  RUSH_HOUR_START: 5,
  RUSH_HOUR_END: 45,
  COFFEE_MACHINE_INITIAL_LEVEL: 1,
  COFFEE_MACHINE_MAX_LEVEL: 5,
  COFFEE_MACHINE_BASE_SPEED_BONUS: 0.15,
  COFFEE_MACHINE_BASE_UPGRADE_COST: 400,
  COFFEE_MACHINE_UPGRADE_MULTIPLIER: 1.8,
} as const;
